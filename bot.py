...
async def handle_dice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if users_spins[uid] == 1:
        text = (
            ...
            f"🎉 Поздравляем с первым спином! В честь этого дарим бесплатную 🧸 "
            ...
            f"<i>Если подарок не пришёл автоматически — сообщите об этом "
            f"@anonveil</i>"
        )
    ...
    if users_spins[uid] % 15 == 0:
        jokes = [
            ...
            "<b>Ты так крутишь,</b> что случайность уже пошла курить в сторонке.",
            "<b>Ещё немного — и автомат сдастся первым.</b>",
            "<b>Я вижу азарт в твоих глазах… продолжай.</b>",
            "<b>Автомат:</b> «Не сегодня». <b>Ты:</b> «Да похуй».",
